...
/**
 * UATIA | Tiny File Manager V2.5.3
 * @author RISHI RAJ PRASAD
 * @email rr8382658@gmail.com
...
//Application Title
define('APP_TITLE', 'LOGIN TO FILE MANAGER');
...
$auth_users = array(
    'Admin' => '$2y$10$/9NtQVJOUpBWXEbLFHbyCOPZNsh24dXgJRoWyGrd/Gj4N/VHocDC2', //lol
    'Rishi' => '$2y$10$Fj/LMfCTszC4xo6GidoBWuu.gdXR2t.yn9Z2fOCJ5C1uLII/JMx02' //lol
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                           <!-- <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="UATIA Tiny File Manager">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://pyq.uatia.us/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">RISHI RAJ PRASAD</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
